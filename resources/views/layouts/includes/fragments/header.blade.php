        ...
        <ul class="nav-left">
            ...
            <li class="search-box">
                <a class="search-toggle no-pdd-right" href="javascript:void(0);">
                    ...
                    <i class="search-icon-close fas fa-close pdd-right-10"></i>
                </a>
            </li>
        ...
        <ul class="nav-right">
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT">
                        <span>
                            <a href="" class="c-grey-600 cH-blue fsz-sm td-n">View All Notifications <i class="fas fa-chevron-right fsz-xs mL-10"></i></a>
                        </span>
                    </li>
                </ul>
            </li>
            <li class="notifications dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="pX-20 pY-15 ta-c bdT">
                        <span>
                            <a href="email.html" class="c-grey-600 cH-blue fsz-sm td-n">View All Email <i class="fs-xs fas fa-chevron-right mL-10"></i></a>
                        </span>
                    </li>
                </ul>
            </li>
                ...
                <ul class="dropdown-menu fsz-sm">
                    ...
                    <li>
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="d-b td-n pY-5 bgcH-grey-100 c-grey-700">
                            <i class="fas fa-power-off mR-10"></i>
                            <span>Logout</span>
